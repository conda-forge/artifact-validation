...
from conda_forge_artifact_validation.feedstock_outputs import (
...
@mock.patch("conda_forge_artifact_validation.feedstock_outputs._dist_exists")
@mock.patch("conda_forge_artifact_validation.feedstock_outputs._get_ac_api_staging")
@mock.patch("conda_forge_artifact_validation.feedstock_outputs._get_ac_api_prod")
...
@mock.patch("conda_forge_artifact_validation.feedstock_outputs._is_valid_output_hash")
@mock.patch(
    "conda_forge_artifact_validation.feedstock_outputs.is_valid_feedstock_output"
)
...
@mock.patch(
    "conda_forge_artifact_validation.feedstock_outputs.STAGING",
    new="conda-forge",
)
...
@mock.patch("conda_forge_artifact_validation.feedstock_outputs.requests")
